...
public class AuthServiceImpl implements AuthService {
    ...
    private LoginResponse buildLoginResponse(String token, Usuario usuario) {
        return LoginResponse.builder()
                ...
                .idAeropuerto(usuario.getAeropuerto() != null ? usuario.getAeropuerto().getIdAeropuerto() : null)
                .codigoOaciAeropuerto(usuario.getAeropuerto() != null ? usuario.getAeropuerto().getCodigoOaci() : null)
                .ciudadAeropuerto(usuario.getAeropuerto() != null ? usuario.getAeropuerto().getCiudad() : null)
                .build();
    }
}
